...
export const Attribute = <T, V extends T>(id: number, template: Template<T>, conformanceValue?: V): Attribute<T> => ({ id, template, optional: false, writable: false, conformanceValue });
export const OptionalAttribute = <T, V extends T>(id: number, template: Template<T>, conformanceValue?: V): OptionalAttribute<T> => ({ id, template, optional: true, writable: false, conformanceValue });
export const WritableAttribute = <T, V extends T>(id: number, template: Template<T>, conformanceValue?: V): WritableAttribute<T> => ({ id, template, optional: false, writable: true, conformanceValue });
export const OptionalWritableAttribute = <T, V extends T>(id: number, template: Template<T>, conformanceValue?: V): WritableAttribute<T> => ({ id, template, optional: true, writable: true, conformanceValue });

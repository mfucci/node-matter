...
export const PressureMeasurementCluster = Cluster({
    ...
    attributes: {
       ...
       tolerance: OptionalAttribute(0x3, TlvUInt16.bound({ min: 0, max: 2048 /* 0x0800 */ }), { default: 0 }),
       ...
       /** Indicates the magnitude of the possible error that is associated with ScaledValue */
       scaledTolerance: OptionalAttribute(0x13, TlvUInt16.bound({ min: 0, max: 2048 /* 0x0800 */ }), { default: 0 }),

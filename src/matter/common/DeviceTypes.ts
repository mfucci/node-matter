...
export const DEVICE = {
     ...
     * For Details see [Matter Device Library R1.0], section 4.1
     */
     ...
     * For Details see [Matter Device Library R1.0], section 4.2
     */
     ...
     * For Details see [Matter Device Library R1.0], section 4.3
     */
     ...
     * For Details see [Matter Device Library R1.0], section 4.4
     */
     ...
     * For Details see [Matter Device Library R1.0], section 5.1
     */
     ...
     * For Details see [Matter Device Library R1.0], section 5.2
     */
     ...
     * For Details see [Matter Device Library R1.0], section 5.3
     */
     ...
     * For Details see [Matter Device Library R1.0], section 6.1
     */
     ...
     * For Details see [Matter Device Library R1.0], section 6.2
     */
     ...
     * For Details see [Matter Device Library R1.0], section 6.3
     */
     ...
     * For Details see [Matter Device Library R1.0], section 7.1
     */
     ...
     * For Details see [Matter Device Library R1.0], section 7.2
     */
     ...
     * For Details see [Matter Device Library R1.0], section 7.7
     */
     ...
     * switch the device on or off.
     * For Details see [Matter Device Library R1.0], section 7.8
     */
     ...
     * handler.
     * For Details see [Matter Device Library R1.0], section 9.1
     */
     ...
     * directly.
     * For Details see [Matter Device Library R1.0], section 9.2
     */
    THERMOSTAT: { name: "MA-thermostat", code: 0x0301 },
    /**
     * This defines conformance to the Fan device type.
     * For Details see [Matter Device Library R1.0], section 9.3
     */
     ...
     * content and is not a content app platform (the Cast­ ing Video Player
     * device type is used for these functions).
     * For Details see [Matter Device Library R1.0], section 10.2
     */
     ...
     * For Details see [Matter Device Library R1.0], section 10.5
     */
     ...
     * app.
     * For Details see [Matter Device Library R1.0], section 10.6
     */
     ...
     * For Details see [Matter Device Library R1.0], section 10.7
     */
     ...
     * For Details see [Matter Device Library R1.0], section 11.1
     */

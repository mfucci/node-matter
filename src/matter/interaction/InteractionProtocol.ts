...
export class SubscriptionHandler {
    ...
    constructor(
        ...
        attributes.forEach(({path, attribute}) => attribute.addMatterListener(subscriptionId, () => this.sendUpdate(path, attribute)));
    }
    ...
    cancel() {
        this.attributes.forEach(({attribute}) => attribute.removeMatterListener(this.subscriptionId));
    }
}
...
describe("Spake2p", () => {
    context("https://datatracker.ietf.org/doc/html/draft-bar-cfrg-spake2plus-01 test vectors", () => {
        const context = util.ByteArray.fromString("SPAKE2+-P256-SHA256-HKDF draft-01");
        ...
        const X = util.ByteArray.fromHex("04a6db23d001723fb01fcfc9d08746c3c2a0a3feff8635d29cad2853e7358623425cf39712e928054561ba71e2dc11f300f1760e71eb177021a8f85e78689071cd");
        const Y = util.ByteArray.fromHex("04390d29bf185c3abf99f150ae7c13388c82b6be0c07b1b8d90d26853e84374bbdc82becdb978ca3792f472424106a2578012752c11938fcf60a41df75ff7cf947");
        const Ke = util.ByteArray.fromHex("ea3276d68334576097e04b19ee5a3a8b");
        const hAY = util.ByteArray.fromHex("71d9412779b6c45a2c615c9df3f1fd93dc0aaf63104da8ece4aa1b5a3a415fea");
        const hBX = util.ByteArray.fromHex("095dc0400355cc233fde7437811815b3c1524aae80fd4e6810cf531cf11d20e3");
    ...
    context("context hash test", () => {
        it("generates the correct context hash", () => {
            ...
            const context = new Array<util.ByteArray>();

            // "CHIP PAKE V1 Commissioning"
            context.push(util.ByteArray.fromHex("434849502050414b4520563120436f6d6d697373696f6e696e67"));
            // PbkdfParamRequest bytes
            context.push(util.ByteArray.fromHex("15300120b2901e92036f7bca007a3a1bf24bd71f18772105e83479c92b7a8af35e8182742502498d240300280435052501881325022c011818"));
            // PbkdfParamResponse bytes
            context.push(util.ByteArray.fromHex(""));
        ...
        it("generates the correct ws0 from the pin", async () => {
            // Test data captured from https://github.com/project-chip/connectedhomeip/
            const pin = 20202021;
            const salt = util.ByteArray.fromHex("438df2ea5143215c4ec5f1bbf7a4d9b1374f62320f2c88e25cc18ff5e5d1bbf6");
